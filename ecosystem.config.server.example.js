module.exports = {
  apps: [
    ...
    // 3. BACKEND: API TES (lapeeh Framework) - UPDATED
    {
      name: "api-tes-lapeeh-web-id",
      cwd: "/var/www/html/node/api-tes-lapeeh-web-id",
      
      // Menggunakan binary lapeeh dari node_modules
