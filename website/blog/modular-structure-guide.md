---
title: "Mengenal Struktur Project Modular di lapeeh Framework"
date: 2025-12-29
author: lapeeh Team
description: "Panduan lengkap memahami perubahan struktur direktori lapeeh Framework menuju arsitektur modular yang lebih terorganisir dan scalable."
tag: "Guide"
---

# Mengenal Struktur Project Modular di lapeeh Framework

Seiring berkembangnya aplikasi, mengelola ratusan file dalam satu folder controller atau model bisa menjadi mimpi buruk. Itulah mengapa mulai versi terbaru, lapeeh Framework mengadopsi pendekatan **Modular Architecture**.
...
Kami juga telah memperbarui sistem tracking di dashboard admin. Kini Anda bisa melihat versi lapeeh CLI mana yang paling banyak digunakan oleh komunitas, membantu kami menentukan prioritas dukungan versi.

## Kesimpulan

Perubahan ini mungkin terasa besar, tapi tujuannya adalah untuk kenyamanan jangka panjang. Dengan struktur modular, lapeeh Framework siap menangani aplikasi dari skala kecil hingga enterprise.

Selamat mencoba struktur baru ini! Jangan lupa jalankan `npx lapeeh init` untuk melihatnya secara langsung.
